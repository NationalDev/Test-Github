...
[CONTACTADDR::addressLine1][CONTACTADDR::city][CONTACTADDR::countryCode][CONTACTADDR::state][CONTACTADDR::zip]
/------------------------------------------------------------------------------------------------------*/

var aa = expression.getScriptRoot();
var addressLine1 = expression.getValue("CONTACTADDR::addressLine1");
...
var validateFlag = expression.getValue("CONTACTADDR::validateFlag");
